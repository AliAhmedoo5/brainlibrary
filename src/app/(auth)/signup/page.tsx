...
import { Mail, Lock, Sparkles, BookOpen, Loader2, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-md rounded-3xl p-8 shadow-2xl border border-white/10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">{dict.appTitle}</h1>
            <p className="text-xs text-gray-400">{dict.createAccount}</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 disabled:opacity-50 transition"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 disabled:opacity-50 transition"
              />
            </div>
          </div>
