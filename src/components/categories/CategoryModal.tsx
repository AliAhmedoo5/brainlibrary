        ...
        <form onSubmit={handleSave} className="mt-5 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition"
            />
          </div>
              ...
              {PRESET_EMOJIS.map((e) => (
                <button
                  ...
                  className={`py-2 rounded-xl text-xl flex items-center justify-center transition border ${
                    emoji === e
                      ? 'bg-blue-500/20 border-blue-500 text-white scale-110 shadow-lg'
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-xl text-sm font-medium text-gray-300 hover:bg-white/10 transition"
            >
              Cancel
            </button>
            <button
